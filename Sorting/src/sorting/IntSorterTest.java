...
public class IntSorterTest {
    ...
    public static long measure(int a[], int n, int method) {
        ...
        switch (method) {
            ...
            break;
            case QUICK1: IntSorter.quickSort1(a, n);
            break;
            case QUICK2: IntSorter.quickSort2(a, n);
            break;
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Quicksort1, Time cost:" + t + " milisec.");
        System.out.println(" Ascending order? " + checkAsc(a, n));
        a = Arrays.copyOf(ar, n);
        t = measure(a, n, QUICK2);
        System.out.print("Quicksort2, Time cost:" + t + " milisec.");
        System.out.println(" Ascending order? " + checkAsc(a, n));
        a = Arrays.copyOf(ar, n);
        t = measure(a, n, HEAP);
